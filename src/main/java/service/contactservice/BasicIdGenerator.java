 ...
 *
 * This class is able to generate unique IDs for any class that extends Contact passed into generateId(entityClass)
 * - Includes static methods for testing, resetCounters(), setCounter(), and printCounters()
 */
public class BasicIdGenerator
{
    private static final Map<Class<? extends Contact>, Long> counters = new HashMap<>();
    ...
    public static String generateId(Class<? extends Contact> entityClass) {
    ...
    public static void setCounter(Class<? extends Contact> counterClass, Long value) {
        counters.put(counterClass, value);
    }

    // print all counters (Excluded unless needed for debug)
    /*public static void printCounters() {
        for (Map.Entry<Class<? extends Contact>, Long> mapElement : counters.entrySet()) {
